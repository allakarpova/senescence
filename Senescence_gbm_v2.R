...
input.path <- '/diskmnt/Projects/cptac_scratch_4/CPTAC3_GBM/snRNA_seq/seurat_all_samples_merged/2020-12-30_merge_then_SCT/seurat_processed_GBM_merged.rds'
out_path <- '/diskmnt/Projects/Users/allakarpova/Projects/senescence/gbm/'
dir.create(out_path, showWarnings = F)
add_filename <- 'gbm_28_sample'
...
my.metadata <- fread('/diskmnt/Projects/cptac_scratch_4/CPTAC3_GBM/single_cell_data_freeze/v2/snRNA/snRNA_metadata.v2.0.tsv.gz', data.table = F) %>% 
