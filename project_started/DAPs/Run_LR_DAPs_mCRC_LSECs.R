...
input.path <- '/diskmnt/Projects/SenNet_analysis/Main.analysis/data_freeze/v1.1/combo_RNA_ATAC/mCRC_SenNet/each_cell_type/34_liver_14_mCRC_combo_Portal.endo.Vascular.endo.LSECs.chromvar.rds'
out_path <- opt$output
