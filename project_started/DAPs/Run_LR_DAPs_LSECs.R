...
input.path <- '/diskmnt/Projects/SenNet_analysis/Main.analysis/data_freeze/v1.1/combo_RNA_ATAC/each_cell_type/34_Merged_normalized_liver_combo_LSECs.Portal.endo.chromvar.rds'
out_path <- opt$output
