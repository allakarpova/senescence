...
input.path <- '/diskmnt/Projects/SenNet_analysis/Main.analysis/data_freeze/v1.1/RNA_only/each_cell_type_harmony/37_Merged_normalized_liver_snRNA_no_doublets_Cholangiocytes_harmony.rds'
out_path <- opt$output
...
fwrite(rbind(deg1, deg2), paste0('DEG_findMarkers_PS_Cholangio_RNA_MAST.txt'), sep = '\t', row.names = F)
