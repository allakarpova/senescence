#Map Xenium object on cell type specific snRNA object and transfer labels 
...
pwalk(list(sample.table$V1, sample.table$V2, sample.table$V3), function(sample, query.path, ref.path){
