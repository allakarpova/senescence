### subset and recluster not tumor cells for sn/scRNA-seq object HTAN BRCA 
...
panc.my <- subset(x = panc, cells = rownames(subset(panc@meta.data, !grepl('Tumor', cell_type_specific))))
